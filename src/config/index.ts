...
export const envConfigs: ConfigMap = {
  app_url: process.env.NEXT_PUBLIC_APP_URL ?? 'https://mechachameleon.games',
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'Mecha Chameleon Game',
  app_description:
    process.env.NEXT_PUBLIC_APP_DESCRIPTION ??
    'Play Mecha Chameleon online free: fast browser game, no download, quick controls, modes, score ideas, and map routes.',
