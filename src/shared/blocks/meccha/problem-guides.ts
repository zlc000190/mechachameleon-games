...
export const problemGuides: Record<string, GuidePage> = {
  ...
  tools: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'FPS and recording settings that keep the game smoother for casual play and clips.',
          'Friend-room rules that reduce kicks, callouts, and wasted public-lobby rounds.',
        ],
      },
      {
    ...
    warnings: [
      ...
      'The Play Kit is positioned as guides, checklists, and browser-safe practice support. It is not a cheat or game-memory tool.',
    ],
    related: [
      { label: 'FPS boost guide', href: '/fps-boost' },
      { label: 'Camo Lab', href: '/camo-lab' },
    ...
    vi: {
      ...
      sections: [
        {
          ...
          bullets: [
            ...
            'Các bước sửa Signing In, join fail và disconnect loop.',
            'Checklist phiên chơi để mở khi bạn bè đang vào phòng.',
          ],
        },
        {
          ...
          bullets: [
            ...
            'FPS và recording settings để chơi và quay clip mượt hơn.',
            'Luật phòng bạn bè để giảm kick, callout và vòng public lãng phí.',
          ],
        },
        {
      ...
      warnings: [
        ...
        'Play Kit là guide, checklist và hỗ trợ luyện tập an toàn trên trình duyệt. Nó không phải cheat hay công cụ đọc bộ nhớ game.',
      ],
      related: [
        { label: 'Hướng dẫn tăng FPS', href: '/fps-boost' },
        { label: 'Camo Lab', href: '/camo-lab' },
        { label: 'Trang chơi', href: '/#play' },
      ],
    },
  },
};
...
export const toolsRadarCards = [
  { icon: Gamepad2, title: '10-min start', risk: 'Play faster', body: 'Controls, paint loop, hider/seeker basics, and first-round mistakes in one checklist.' },
  { icon: Globe2, title: 'Lobby fix', risk: 'Less waiting', body: 'Private room setup, server tags, room codes, and workshop-map checks before friends join.' },
  { icon: Gauge, title: 'FPS boost', risk: 'Smoother play', body: 'Reversible settings for low-end PCs, streaming, recording, and stable frame pacing.' },
  { icon: Palette, title: 'Camo practice', risk: 'Better hides', body: 'Color-matching drills, shadow correction habits, and route-card prep before a round.' },
] as const;
